...
export function firstGradeRuleExplanation(levelId: LevelId, grade: number): string | null {
  ...
  if (grade === 2) {
    return `برای پایه دوم، دو قانون «عدم تکرار در روز» و «عدم تکرار در یک شماره‌زنگ هفته» به‌درخواست شما غیرفعال شده‌اند؛ برخلاف پایه اول، این مورد یک ضرورت ریاضی نیست (بالاترین ساعت هفتگی این پایه ۵ ساعت است و در ۵ روز بدون تکرار هم قابل‌چیدمان بود)، بلکه برای انعطاف بیشتر چیدمان انتخاب شده است.`
  }
