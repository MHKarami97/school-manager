  ...
  <Transition name="slide-up">
    ...
    >
      <div class="flex w-full max-w-md items-center gap-3 rounded-2xl border border-ink-200 bg-white p-4 shadow-xl">
        <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-brand-50 text-brand-600">
        ...
        <div class="flex-1 text-sm">
          <p class="font-medium text-ink-800">نسخه جدیدی از مدیریار در دسترس است</p>
          <p class="mt-0.5 text-ink-500">برای استفاده از امکانات و اصلاحات جدید، صفحه را به‌روزرسانی کنید.</p>
        </div>
        <button
          type="button"
