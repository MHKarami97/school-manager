...
<template>
  <footer id="contact" class="border-t border-ink-100 bg-white dark:border-ink-800 dark:bg-ink-900">
    <div class="mx-auto grid max-w-6xl gap-8 px-4 py-12 sm:px-6 md:grid-cols-3">
      ...
      <div>
        ...
        <ul class="mt-3 space-y-2 text-sm text-ink-500 dark:text-ink-400">
          <li>
            ایمیل:
            <a href="mailto:mhkarami97@gmail.com" class="text-brand-600 hover:underline dark:text-brand-400">mhkarami97@gmail.com</a>
          </li>
          <li>
            وب‌سایت:
            <a href="https://mhkarami97.ir" target="_blank" rel="noopener" class="text-brand-600 hover:underline dark:text-brand-400">mhkarami97.ir</a>
          </li>
          <li>
            مخزن پروژه:
            <a href="https://github.com/MHKarami97/school-manager" target="_blank" rel="noopener" class="text-brand-600 hover:underline dark:text-brand-400">GitHub</a>
          </li>
        </ul>
      </div>
